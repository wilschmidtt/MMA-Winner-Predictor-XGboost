...
# =============================================================================
answer = input('The machine learning algorithm has been trained using XGboost and the data provided. Would you like to have it make a fight-winner-predicition based on user-defined data? Enter "yes" or "no": ').lower()
loop = True
while loop:
...
# =============================================================================
    ...
    user_data_pred = classifier.predict(user_data) # 0 for red, 1 for blue
    user_data_pred = np.where(user_data_pred_percentage > 0.50, 'Blue', 'Red')
    print(f'The model predicts that the fighter in the {user_data_pred[0]} corner will win.')
